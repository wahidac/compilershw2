...
public class TypeChecker extends GJNoArguDepthFirst<Boolean> {
	...
	public TypeChecker(HashMap<String, ClassBinding> symbolTable) {
		//Use to calculate type of expressions
		typeCalculator = new TypeCalculator();
